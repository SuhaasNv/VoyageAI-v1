        ...
        <section className="relative py-24 px-6 lg:px-12 bg-[#0A0D12] overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 mb-20 mt-10">
                ...
                <div className="hidden lg:block">
                    <MotionDiv animate={{ y: [0, -10, 0] }} transition={{ duration: 4, repeat: 2, ease: "easeInOut" }} className="absolute top-10 left-10 w-12 h-12 rounded-full border-2 border-[#10141a] overflow-hidden z-20"><Image src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80" alt="avatar" fill className="object-cover" /></MotionDiv>
                    <MotionDiv animate={{ y: [0, 15, 0] }} transition={{ duration: 5, repeat: 2, ease: "easeInOut", delay: 1 }} className="absolute top-32 left-32 w-10 h-10 rounded-full border-2 border-[#10141a] overflow-hidden z-20"><Image src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80" alt="avatar" fill className="object-cover" /></MotionDiv>
                    <MotionDiv animate={{ y: [0, -15, 0] }} transition={{ duration: 4.5, repeat: 2, ease: "easeInOut" }} className="absolute bottom-10 left-48 w-14 h-14 rounded-full border-2 border-[#10141a] overflow-hidden z-20"><Image src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80" alt="avatar" fill className="object-cover" /></MotionDiv>
                    <MotionDiv animate={{ y: [0, -10, 0] }} transition={{ duration: 4, repeat: 2, ease: "easeInOut", delay: 0.5 }} className="absolute top-20 right-20 w-12 h-12 rounded-full border-2 border-[#10141a] overflow-hidden z-20"><Image src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=150&q=80" alt="avatar" fill className="object-cover" /></MotionDiv>
                    <MotionDiv animate={{ y: [0, 10, 0] }} transition={{ duration: 3.5, repeat: 2, ease: "easeInOut", delay: 1.5 }} className="absolute bottom-20 right-32 w-10 h-10 rounded-full border-2 border-[#10141a] overflow-hidden z-20"><Image src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=150&q=80" alt="avatar" fill className="object-cover" /></MotionDiv>
                </div>
            </div>
